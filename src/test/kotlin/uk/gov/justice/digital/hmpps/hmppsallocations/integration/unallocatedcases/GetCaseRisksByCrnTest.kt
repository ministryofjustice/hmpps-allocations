...
class GetCaseRisksByCrnTest : IntegrationTestBase() {
  ...
  fun `can get case risks V1 by crn and convictionNumber`() {
    ...
    webTestClient.get()
      ...
      .isEqualTo("HIGH")
      .jsonPath("$.risk.violencePredictorScore.twoYears")
      .isEqualTo(50)
      .jsonPath("$.risk.violencePredictorScore.ovpRisk")
      .isEqualTo("MEDIUM")
  ...
  fun `can get case risks V2 by crn and convictionNumber`() {
    ...
    webTestClient.get()
      ...
      .isEqualTo("HIGH")
      .jsonPath("$.risk.seriousViolentReoffendingPredictor.score")
      .isEqualTo(99)
      .jsonPath("$.risk.seriousViolentReoffendingPredictor.band")
      .isEqualTo("HIGH")
      .jsonPath("$.risk.directContactSexualReoffendingPredictor.score")
      .isEqualTo(10)
      .jsonPath("$.risk.directContactSexualReoffendingPredictor.band")
      .isEqualTo("LOW")
      .jsonPath("$.convictionNumber")
      .isEqualTo(1)
  }
