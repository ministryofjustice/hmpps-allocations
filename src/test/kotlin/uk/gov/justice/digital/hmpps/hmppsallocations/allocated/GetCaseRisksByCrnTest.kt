package uk.gov.justice.digital.hmpps.hmppsallocations.allocated
...
class GetCaseRisksByCrnTest : IntegrationTestBase() {
  ...
  @Test
  fun `can get case risks by crn`() {
    val crn = "J678910"
    workforceAllocationsToDelius.userHasAccess("J678910")
    insertCases()
    workforceAllocationsToDelius.getCrnDetails(crn)
