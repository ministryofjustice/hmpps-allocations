...
class JwtAuthHelper {
  ...
  fun createJwt(
    ...
    val claims = mutableMapOf<String, Any?>("user_name" to userName, "client_id" to clientId, "user_id" to userId, "name" to name, "auth_source" to authSource, "is_client_grant_type" to isClientIdGrantType)
